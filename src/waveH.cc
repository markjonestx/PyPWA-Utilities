...
void wave::printFrames() const {
    cout << "wave: " << endl;
    cout << "beam: "; this->_beam.print();
    cout << "target: "; this->_target.print();
...
wave & wave::setupFrames (int debug)
{
	...
	if (debug) {
	    ...
	    cout << "tempX: "; tempX.print();
	    cout << "tempBeam: "; tempBeam.print();
	    cout << "tempTarget: "; tempTarget.print();
	    cout << "tempChild1: "; tempChild1.print();
	}
